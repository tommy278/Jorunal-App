...
export default function Login () {
  ...
  const box = "flex flex-col items-center justify-center space-y-4 w-2/5 sm:w-2/3 md:w-2/5 h-1/2 border border-gray-300 rounded shadow-md bg-white/10 backdrop-blur-md"
